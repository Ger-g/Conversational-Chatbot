...
class BotTrainer(object):
    def __init__(self, corpus_dir):
        ...
        with self.graph.as_default():
            ...
            self.model = ModelCreator(training=True, tokenized_data=tokenized_data, batch_input=self.train_batch)

    def train(self, result_dir, target=""):
        """Train a seq2seq model."""
        # Summary writer for printing training results to TensorBoard
        ...
        with tf.Session(target=target, config=config_proto, graph=self.graph) as sess:
            ...
            while train_epoch < num_epochs:
                ...
                try:
                    ...
                    epoch_hr = round(((epoch_dur /  60) / 60), 2)
